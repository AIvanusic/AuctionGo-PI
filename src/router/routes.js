const routes = [
  {
    ...
    children: [
      ...
      { path: 'auctiondetail/:id', component: () => import('pages/AuctionDetailPage.vue') },
      ...
      { path: 'manager-dashboard', component: () => import('pages/ManagerPage.vue') },
      { path: 'auctions', component: () => import('pages/AuctionsPage.vue') },
    ],
  },
